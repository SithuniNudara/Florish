...
public class MyAccount extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (session != null && session.getAttribute("user") != null) {
            ...
            String since = new SimpleDateFormat("MMM yyyy").format(user.getCreatedAt());
            responseObject.addProperty("since", since);
            String joined = new SimpleDateFormat("yyyy-MM-dd").format(user.getCreatedAt());
            responseObject.addProperty("joined", joined);
